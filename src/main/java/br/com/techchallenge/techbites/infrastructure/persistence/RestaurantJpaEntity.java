...
@SQLDelete(sql = "UPDATE tb_restaurants SET active = false WHERE restaurant_id = ?")
public class RestaurantJpaEntity {
    ...
    public boolean equals(Object o) {
        ...
        RestaurantJpaEntity that = (RestaurantJpaEntity) o;
    ...
    public String toString() {
        return "RestaurantJpaEntity{" + "id=" + id + ", name='" + name + '\'' + ", description='" + description + '\'' + ", address=" + address + ", cuisine='" + cuisine + '\'' + ", openingHour='" + openingHour + '\'' + ", owner=" + owner + ", createdAt=" + createdAt + ", lastUpdatedAt=" + lastUpdatedAt + ", active=" + active + '}';
    }
}
